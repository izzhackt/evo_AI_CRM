  ...
  return (
    <section className="border-border bg-card flex h-full flex-col rounded-xl border">
      ...
      <footer className="border-border text-muted-foreground flex items-center gap-4 border-t px-5 py-3 text-xs">
        <LegendDot
          color="#3b82f6"
          label={t('dashboard.conversations.incoming')}
        />
        <LegendDot
          color="#7c3aed"
          label={t('dashboard.conversations.outgoing')}
        />
      </footer>
    </section>
  );
        ...
        >
          ...
          <div className="mt-1 flex flex-col gap-0.5">
            <span className="flex items-center gap-1.5 text-blue-300">
              ...
              {t('dashboard.conversations.incomingCount', {
                count: hovered.incoming,
              })}
            </span>
            <span className="text-primary flex items-center gap-1.5">
              <span className="bg-primary inline-block h-1.5 w-1.5 rounded-full" />
              {t('dashboard.conversations.outgoingCount', {
                count: hovered.outgoing,
              })}
            </span>
          </div>
        </div>
