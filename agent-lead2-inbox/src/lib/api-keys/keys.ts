...
//
// Why the `evoinbox_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an EVO Inbox key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for an `evoinbox_test_` variant if
...
export const API_KEY_PREFIX = 'evoinbox_live_';
