...
| CRM-01: текущие количества в воронке продаж | Исходники реализованы; обычные Auth/RPC/UI на прежних локальных QA-входах проверены, ограничения и старое board-расхождение — в [квитанции](qa/crm-01-current-funnel-2026-09-20.md) | #943 ожидает merge после docs-delta review/CI; SQL210 применена только локально, production не изменён |
