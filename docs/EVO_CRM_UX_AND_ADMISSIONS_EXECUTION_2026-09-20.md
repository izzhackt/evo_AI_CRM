...
| CRM-01: текущие количества в воронке продаж | Исходники реализованы; технические проверки и ограничения — в [квитанции](qa/crm-01-current-funnel-2026-09-20.md). Реальная приёмка нового RPC/UI ещё не выполнена | DRAFT #943; SQL210 не применялась, production не изменён |
