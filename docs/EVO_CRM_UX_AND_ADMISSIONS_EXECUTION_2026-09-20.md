...
| CRM-02: права, продавец, дата/месяц, поиск/финансы/UX | CRM-02a реализован, технические проверки ниже; живой write-путь ждёт отдельной authority. Остальная часть CRM-02 открыта | PR pending; production не изменён |
