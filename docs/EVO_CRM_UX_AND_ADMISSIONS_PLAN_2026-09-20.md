...
- Расположение большой сводки и списка студентов сохранить: владелец подтвердил текущую компоновку. См. раздел 14.
...
Обновление22.09: владелец поручил определить запись самостоятельно. Идентификация по исходному тестовому handoff и аудиту выполнена; штатное архивирование в production принято с сохранением остальных209 продаж и истории. [Квитанция](qa/service-sale-archive-actual-2026-09-22.md). Этот точечный шаг завершён.
