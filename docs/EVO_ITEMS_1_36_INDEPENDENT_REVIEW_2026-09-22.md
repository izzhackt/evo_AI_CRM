...
| 14 | Staff каталог: `UniversityCatalogue`, `university-staff-deadline.ts`, SQL236/238 | [#1008](https://github.com/izzhackt/evo_AI_CRM/pull/1008)/[#1016](https://github.com/izzhackt/evo_AI_CRM/pull/1016)/[#1019](https://github.com/izzhackt/evo_AI_CRM/pull/1019): компактный список, полный список стран опубликованного staff-каталога (SQL236), только sourced deadline, отдельный manage search. Actual b8497ad4 и manage receipt; positive Next/deadline/draft отсутствовали. |
...
| Каталог | 1440/320; поиск существующего Guangdong через Enter дал одну карточку; actual фильтр стран содержит CN | В текущих QA-данных опубликован только CN; фильтр получает все страны опубликованного staff-каталога по SQL236, остальные значения UI не проверены. Ограничение шестью странами относится к подготовке документов (пункт17). Все внешние фото не проверялись |
