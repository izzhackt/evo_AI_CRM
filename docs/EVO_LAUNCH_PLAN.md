...
| 5 | #599 | Confirmed schema gaps | complete the confirmed V3 gaps through forward Supabase migrations: dynamic two-state document checklists, private company knowledge files, explicit all-day task deadlines, exact sales stage-entry reporting, application priority/deadline and case-safe document links; reuse the existing staff, profile, payment and case-task authorities |
