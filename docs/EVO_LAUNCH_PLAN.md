...
| 4 | #598 | Remaining Supabase reuse | complete document checklist/review richness, expose the existing audit CSV export in V3, enrich visa presentation only from the existing canonical snapshot, and remove the exact superseded surfaces |
