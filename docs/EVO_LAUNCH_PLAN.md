...
- [ ] S1 Заявки и доступ: одна очередь трёх источников под Продажами; анкета
...
- [ ] S2 Карточка Sales: структурные блоки и условия продажи на карточке;
  в отчёте — выбор лида и куратора с предпросмотром; обходная передача из
  карточки убрана.
- [ ] S3 Принятие дела: «Ожидает принятия», Принять/Отклонить; отклонение
  возвращает дело в «Нужно назначить куратора»; админ назначает внутри дела.
- [ ] S4 Admissions без трекера: «Вузы и программы» вместо «Маршрута»; без
  этапов, виз, подачи и прибытия; документы, пакет и история сохраняются.
- [ ] S5 Портал одного дела: экран «Заявки и виза» убран; кабинет до продажи
  (анкета, файлы по мере появления); этап-пилюля убрана.
- [ ] S6 Docs и наименования: без прямого создания студента; «Студенты»,
