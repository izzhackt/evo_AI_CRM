...
Текущий статус: локальные SQL/Auth и пустой selector проверены на35499c33/1b903e23;
окно освобождено A234. [Actual-квитанция](qa/crm-sales-directions-actual-2026-09-21.md)
содержит ограничения: populated selection пока не подтверждён существующими данными.
Ниже сохранён исходный precode-контракт и его история.
