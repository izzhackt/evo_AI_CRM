...
Статус на 21 сентября: исходники и локальный apply235 завершены; доступные
ordinary Auth/UI сценарии проверены на3616ea17. [Actual report](qa/crm-sales-management-actual-2026-09-21.md)
сохраняет непроверенные ветки, включая refresh retention. Ниже исходный precode
контракт; production и отдельный перенос импорта7b сюда не входят.
