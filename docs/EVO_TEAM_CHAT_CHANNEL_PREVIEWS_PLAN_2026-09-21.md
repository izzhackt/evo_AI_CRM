...
Статус: independent precode APPROVED, 2026-09-21. ROOT разрешил первый
...
перехода в него. Сейчас краткий текст доступен только у выбранного канала,
...
Сейчас доказана структура проблемы и ограниченный способ реализации.
Рабочий preview всех каналов, новый SQL/RPC, actual acceptance, весь пункт15,
пункты1–36 и production здесь не объявляются завершёнными.
...
исходного принятого precode выше сохраняются. SQL237 пока не применялась.
