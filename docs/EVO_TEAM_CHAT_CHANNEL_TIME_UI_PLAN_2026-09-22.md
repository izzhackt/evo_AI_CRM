...
Статус: precode review APPROVED; код и адресные проверки готовы на `4e434eee`.
Source review, protected CI и actual UI ещё ожидаются; этот срез не принят целиком.
Доказательства и ограничения — в [source-квитанции](qa/team-chat-channel-time-ui-source-2026-09-22.md).
