...
Эта страница — входная точка в продуктовые знания о платформе. Она помогает
...
### Общий контекст и продуктовый бренд

- [Общий контекст EVO](https://github.com/izzhackt/EVO) — отдельный приватный
  репозиторий; нужен доступ компании. CRM и сайт остаются независимыми репозиториями.
- [Граница бренда и корпоративных материалов](company/README.md)
- [Logobook, закреплённый в CRM](company/brand/evo-admissions-logobook.pdf)

Этот CRM-репозиторий публичный. Корпоративные оригиналы и их локальный реестр
перенесены в игнорируемую папку `EVO/Компания/`, вне Git обоих репозиториев.
Их содержимое и банковские/персональные данные здесь не публикуются.
Продуктовые бизнес-документы, презентации и используемые кодом/тестами ресурсы
остаются в CRM; сборка не зависит от доступа к приватному общему контексту.
