...
Generated: 2026-06-24T10:00:01.981Z
...
- Temp DB: `/var/folders/p4/c09jb8gd4qngjbkr1cqfh8rh0000gp/T/evo-crm-scenarios-76175-1782295200109/edu-admin.db` (isolated copy; removed after the run unless
...
| S08 | Admissions Pipeline | Add lead Server Action creates an EVO admissions lead. | Submitting the real /sales lead form inserts a lead with source, target country, manager, and amount. | PASS | created lead 8 status new, Canada, 120000 KGS |
...
| S10 | Admissions Pipeline | Convert lead Server Action creates Student 360 client and marks lead won. | Converting an unconverted lead creates a client, links it to the lead, and sets status won. | PASS | lead 9 converted to client 5 |
