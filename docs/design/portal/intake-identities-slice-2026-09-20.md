...
Статус: спецификация зафиксирована до runtime-кода; B3a реализована и проверена
на одной существующей локальной карточке обычными Admin/Student. Managed211,
массовые технические публикации и новый выбор программы ещё не выполнены.
Исходная основа main `6da4f354d1a7af88bfbb19b11c3e2546606ae114` (207–209);
интегрирован main `1795bf23` (210), runtime проверки `21eb53b3`.
Точная область и ограничения: [квитанция](../../qa/b3-intake-identities-2026-09-20.md).
