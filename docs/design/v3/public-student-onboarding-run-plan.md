...
Дата: 2026-09-18. Статус: draft PR830 объединён с main99ac5aa3; Student SQL зарезервирован как177. Новая интеграция не проверена, дополнительные прогоны отменены владельцем. Регистрация не опубликована; выбор подтверждения email ожидает решения.
