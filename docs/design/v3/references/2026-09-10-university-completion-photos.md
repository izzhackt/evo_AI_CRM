...
Финальный readback после принятия `892558b2` (release34530968045 attempt1):
все 143 используемые фотографии загрузились в staff-каталоге на пяти страницах.
Обе замены также загрузились в карточках Admin Student preview: GBS1600×1200,
Huashang1080×650, без fallback. Неиспользуемый резервный ключ HIT Shenzhen
не входит в denominator143. Никакой повторной публикации каталога не было.
