...
- Каталог ролей расширяет существующие bundles. Publish создаёт новую immutable
  ...
  замены либо снятия назначений в одной проверенной операции.
...
UI-счётчики для диагностики; полного прохода и подтверждающих screenshots нет.
...
Новый полный unit-запуск прошёл: 144 уникальных Node-файла, 1426 проверок
...
`77cde9ba`; S2 — локальный, незакоммиченный и невыпущенный; PR ещё не создан.
