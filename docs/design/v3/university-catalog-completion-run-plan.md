...
Текущий принятый app `1a7f870b`; актуальное продолжение #729 описано ниже.
...
подтвердили новый общий reader. В заголовке страницы студента обнаружена старая
фраза об уточнениях вне общего reader: осталось заменить только description двух
real/preview route wrappers, выпустить и повторить UI check. Повторная публикация
данных или миграции не требуются. Доказательства и точная точка продолжения:
...
3. Последний принятый app `1a7f870b`, schema001–151, каталог143; перед новой
   работой проверить живые SHA/ledger/arm. Release34568354768 attempt1 принят,
