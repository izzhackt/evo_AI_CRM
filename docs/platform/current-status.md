...
- Sources: интеграционный базовый коммит `12107b89`, коммит документации
  `86c4175d` и PR #32, `git`, GitHub CLI, файлы репозитория, DNS-проверка через
  `dig`, публичные HTTPS-запросы
...
| Документация source of truth | Технический ответственный | PR #32 открыт из `izzhackt/evo-source-of-truth` в интеграционную ветку; проверяемый коммит — `86c4175d` | 2026-07-12 | `gh pr view 32` |
