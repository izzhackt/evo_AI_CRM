...
| Интеграционная основа | Технический ответственный | Ветка `izzhacktcodex/waha-integration`, коммит `4edbe185`; после merge PR #32 она на 34 коммита впереди `origin/main` | 2026-07-13 | `git rev-list`, `git rev-parse` |
| Документация source of truth | Технический ответственный | PR #32 объединён с интеграционной веткой; merge-коммит — `4edbe185` | 2026-07-13 | `gh pr view 32` |
| Доставка изменений в `main` | Технический ответственный | После PR #32 вся интеграционная ветка требует отдельного review и PR в `main`; `main` пока не содержит весь актуальный контекст платформы | 2026-07-13 | `gh pr list`, `git rev-list` |
