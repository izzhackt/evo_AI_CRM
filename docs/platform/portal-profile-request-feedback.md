...
одобрен, код реализован и source checks пройдены. Actual остановлен на маршруте
входа существующего QA Student; профиль и transport rejection не проверены.
Собственная сессия и ресурсы закрыты, полная сверка данных пройдена;
