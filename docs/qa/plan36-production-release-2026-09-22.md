...
Последующая поставка: [accepted0aceda06 и приёмка #1026/#980 владельцем](signup-owner-acceptance-delivery-2026-09-22.md).
Ниже сохранены прежние релизы и ограничения на момент их выполнения.
