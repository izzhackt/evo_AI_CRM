...
Исторический source-срез до actual. Последующий реальный проход и закрытие среды
зафиксированы в [отдельной квитанции](staff-catalog-compact-actual-2026-09-21.md);
ниже прежние проверки/ограничения не переобозначены новым запуском.
