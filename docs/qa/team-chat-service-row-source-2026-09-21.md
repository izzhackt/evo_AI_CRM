...
Исторический source-этап: ограниченная реализация и проверки исходников готовы;
на этом этапе actual UI/review/merge ещё ожидались, результат на телефоне
и выигрыш плотности не заявлялись. Позднейший один actual batch и независимая
приёмка описаны в [отдельной квитанции](team-chat-service-row-actual-2026-09-21.md).
