...
| FR-081 | реализовано | `src/lib/platform-observability.ts`, `src/app/(staff)/settings` | `tests/platform-observability-config.test.mjs`, скриншот `07-settings-readiness-desktop-1440.png` |
...
| FR-083 | реализовано | versioned bundles в миграции 041 | `tests/platform-auth-config.test.mjs` |
