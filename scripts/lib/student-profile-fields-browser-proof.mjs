...
function configuration() {
  const deferAcceptance = process.env.EVO_D2_DEFER_ACCEPTANCE ?? "0";
  ...
  return { appOrigin, apiOrigin, dbUrl: dbUrl.toString(), evidenceDir, organizationId, email,
    ...
    storageServiceKey: env("EVO_D2_STORAGE_SERVICE_KEY"), projectId, deferAcceptance: deferAcceptance === "1" };
}
