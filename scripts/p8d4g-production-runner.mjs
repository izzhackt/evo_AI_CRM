...
export const P8D4G = Object.freeze({
  ...
  confirmation: "EXECUTE-P8D4G-2026-08-16.P8D4G.1",
  windowMs: 120 * 60 * 1000,
  deployments: Object.freeze(["inbox", "crm", "lead_agent"]),
  pilots: Object.freeze(["client_china_documents", "internal_malaysia_handoff"]),
  productionEvidenceRoot: resolve(fileURLToPath(new URL("..", import.meta.url)), `.evo-release-evidence/p8d4g-${"2026-08-16.p8d4g.1"}`),
});
