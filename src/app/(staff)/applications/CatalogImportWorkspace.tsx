...
function ApprovedCatalog({
  ...
  return (
    <Card>
      <div data-testid="platform-approved-catalog">
    ...
    <div className="grid gap-4 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
              ...
              <select name="source_registry_id" className={`${inputCls} mt-1`}>
                {reviewedSources.map(({ source }) => (
                  <option key={source.sourceRegistryId} value={source.sourceRegistryId}>
                    {SOURCE_KIND_LABELS[source.sourceKind]} · {source.sourceUrl} ·{" "}
      ...
      <Card>
        ...
        {admin.batches.length === 0 ? (
          ...
          <div
            data-testid="platform-catalog-batch-list"
            ...
            {admin.batches.map((batch) => (
              ...
              >
                <div>
                  ...
                  <div className="mt-1 break-all text-[10.5px] text-fg-3">
                    {SOURCE_KIND_LABELS[batch.sourceKind]} · {batch.sourceUrl}
                  </div>
...
function SelectedBatch({
  ...
  return (
    <Card>
      <div
        data-testid="platform-catalog-batch-detail"
