...
export const metadata: Metadata = {
  title: "Задать пароль | EVO Admissions",
...
export default async function StudentSetPasswordPage() {
  ...
  if (inviteSession.status === "invalid") {
  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-bg px-4 py-10">
      ...
      >
        ...
        <h1 id="password-title" className="text-2xl font-bold leading-tight text-fg">
          Задайте пароль
        </h1>
        <p className="mt-2 text-sm leading-6 text-fg-3">
          Этот пароль будет использоваться для защищённого входа в личный
          кабинет EVO.
        </p>
