...
export default async function RegisterPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-10">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-lg border border-[var(--evo-border)] bg-white shadow-[var(--evo-shadow-md)] lg:grid-cols-[1fr_440px]">
        <section className="hidden min-h-[580px] bg-[linear-gradient(135deg,#0f172a_0%,#1d4ed8_62%,#0e7490_100%)] p-10 text-white lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-6 text-blue-50">{t("registerIntro")}</p>
          </div>
        ...
        <section className="p-6 sm:p-8">
          <div className="mb-8 flex items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-1 text-xl font-semibold text-slate-950">{t("register")}</h1>
              <p className="mt-1 text-sm text-slate-500">{t("registerIntro")}</p>
            </div>
