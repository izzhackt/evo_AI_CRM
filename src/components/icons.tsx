...
// Lightweight line-icon set (lucide-equivalent), 1.8px stroke, currentColor.
export type IconName =
  ...
  | "grip-vertical"
  | "lock"
  // Новый облик (Э1.2, временно до Э1.5, izzhackt/evo_AI_CRM#1061): у трёх
  // пунктов меню не было своего знака — два пузыря на три переписки и ни
  // одного на шаблоны и документы. Прежний облик их не использует.
  | "messages-square"
  | "quote"
  | "file-text";
...
const PATHS: Record<IconName, string> = {
  ...
  "bar-chart":
    '<path d="M3 3v18h18"/><rect x="7" y="10" width="3" height="7" rx="0.6"/><rect x="12" y="6" width="3" height="11" rx="0.6"/><rect x="17" y="13" width="3" height="4" rx="0.6"/>',
  wallet:
    '<rect x="3" y="6" width="18" height="14" rx="2.2"/><path d="M3 10h18"/><circle cx="16.5" cy="14.5" r="1.2"/>',
  settings:
  ...
  "call-in": '<path d="M17 7 7 17"/><path d="M17 17H7V7"/>',
