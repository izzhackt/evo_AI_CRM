...
export async function FinanceEntryWorkspace({ caseId }: Readonly<{ caseId: string }>) {
  ...
  catch { return <Card title="Дополнительные финансовые операции"><p role="alert" className="px-4 py-3 text-sm text-fg-2">Финансовая история сейчас недоступна. Обновите страницу; новые операции пока остановлены.</p></Card>; }
  return <Card title="Дополнительные финансовые операции"><div className="px-4 py-3">
