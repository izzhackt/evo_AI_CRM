                ...
                {workload.map((curator) => {
                  ...
                  return (
                    <tr
                      ...
                      className={`relative ${ROW_GRID} border-b border-border py-2 t-body-compact @min-[40rem]/curators:py-0 ${selected ? "bg-surface-2" : "hover:bg-surface has-[[data-queue-open]:focus-visible]:bg-surface"}`}
                    >
