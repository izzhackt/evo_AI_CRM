  ...
  return (
    <div className={panel ? "xl:grid xl:grid-cols-[minmax(0,1fr)_26rem] xl:items-start xl:gap-6" : undefined}>
      {/*
        ...
        Mono «ДД.ММ»; выбранное — .v3-choice; сплошного красного #d70217 на
        странице нет (у очереди нет своего главного действия, «Создать задачу» в
        верхней панели с 25.09 нейтральная); подтверждения — тёмные нейтральные.
