...
export function UniversityList({ page, filters, base, canManage = false, now = new Date() }: { page: UniversityPage; filters: UniversityFilters; base: "/v3/universities" | "/portal/universities"; canManage?: boolean; now?: Date }) {
