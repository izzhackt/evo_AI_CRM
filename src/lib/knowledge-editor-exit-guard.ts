...
/** Keep unsaved knowledge drafts in memory; never persist content in browser storage. */
export function installKnowledgeEditorExitGuard({ blocked, notify }: GuardOptions): () => void {
