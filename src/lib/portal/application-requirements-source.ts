...
async function readRequirements(
  ...
  rpc: "student_application_requirements_v1" | "staff_application_requirements_v1",
  ...
  try {
    ...
    const requirements = !error && parseApplicationRequirements(data, target.studentCaseId, target.applicationId);
...
export async function readStudentApplicationRequirements(studentCaseId: string, applicationId: string) {
  ...
  return readRequirements(studentCaseId, applicationId, "student_application_requirements_v1");
}
...
export async function readStaffApplicationRequirements(studentCaseId: string, applicationId: string) {
  ...
  return readRequirements(studentCaseId, applicationId, "staff_application_requirements_v1");
}
