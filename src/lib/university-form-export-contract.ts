...
export function normalizeUniversityFormInput(value: unknown): FormInput {
  ...
  const f = formInputRecord(row.form, ["application_id", "catalog_institution_id", "catalog_source_revision", "template_id", "template_version_id",
  ...
  const form: FormBinding = Object.freeze({ application_id: formInputUuid(f.application_id), catalog_institution_id: formInputUuid(f.catalog_institution_id),
