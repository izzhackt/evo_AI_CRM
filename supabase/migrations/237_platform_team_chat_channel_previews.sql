-- Bounded last-message metadata inside the existing authorized channel reader.
-- Preserve 225 sparse unread semantics and 156 scoped staff channel authority.
BEGIN;
