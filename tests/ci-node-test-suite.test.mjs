...
test("CI Node suite runs the former security and unit surface once", () => {
  ...
  assert.equal(bounded.files.length, 188); // + PORT-9a, + PORT-9d (tests/university-photo-storage.test.mjs), + «Студенты» facets, + «Задачи» queue, + «Студенты» queue backend, + boards, + «Сообщения» order, + new look preview, + truthful state, + access by permissions 244, + case work, + new look shell (Э1.2), + «Сегодня», + closure 246 (tests/v3-lead-case-closure.test.mjs)
