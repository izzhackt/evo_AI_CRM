...
test("retry evidence uses the collision-free P8D4Q identity", () => {
  assert.equal(P8D4G.releaseId, "2026-08-17.p8d4q.1");
  assert.match(P8D4G.productionEvidenceRoot, /p8d4g-2026-08-17\.p8d4q\.1$/);
  assert.equal(P8D4G.confirmation, "EXECUTE-P8D4Q-2026-08-17.P8D4Q.1");
});
