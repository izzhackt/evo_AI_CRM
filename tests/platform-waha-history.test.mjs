...
test("the isolated browser build admits the P5C through U7 partitions", async () => {
  ...
  assert.match(
    nextConfigSource,
    /new Set\(\[\s*"provider",\s*"p5b",\s*"p5c",\s*"p5d",\s*"p5e",\s*"p5f1",\s*"p5f3",\s*"p6a",\s*"p6b",\s*"p6c",\s*"p6d",\s*"p7a",\s*"p7b",\s*"u2",\s*"u6",\s*"u7",\s*"remaining",?\s*\]\)/,
  );
  assert.match(
    resetHarnessSource,
